...
interface SidebarProps {
  currentView: 'dashboard' | 'geradores' | 'consumidores' | 'pendentes' | 'representantes' | 'propostas' | 'usuarios' | 'logs' | 'configuracoes' | 'comissoes';
  onViewChange: (view: 'dashboard' | 'geradores' | 'consumidores' | 'pendentes' | 'representantes' | 'propostas' | 'usuarios' | 'logs' | 'configuracoes' | 'comissoes') => void;
}
...
export default function Sidebar({ currentView, onViewChange }: SidebarProps) {
  ...
  menuItems.push({ id: 'propostas', label: 'Propostas', icon: FileText, view: 'propostas' as const, description: 'Geração de propostas' });
    ...
    <>
      ...
      <div 
        className={`
          ...
          bg-gradient-to-b from-[#0c3a59] via-[#0b3049] to-[#081f31] w-72 flex flex-col shadow-2xl border-r border-slate-800/60 overflow-y-auto
