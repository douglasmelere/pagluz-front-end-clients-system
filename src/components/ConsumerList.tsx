  ...
  if (consumers.length === 0) {
    return (
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-12 text-center">
        ...
        <h3 className="text-lg font-medium text-slate-900 font-display">Nenhum consumidor encontrado</h3>
        <p className="mt-1 text-slate-500 font-display">Tente ajustar seus filtros ou cadastre um novo consumidor.</p>
      </div>
    );
  }
